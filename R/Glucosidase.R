...
# Manually corrected the C1 of S16 to see if it makes sense to do a temperature correction. I used the safety replicate of S16_A_C1_temp_replicate plate ratio (=1.7902)
